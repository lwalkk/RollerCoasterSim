...
void Cube::Draw(mat4& MV, mat4& MVP, vec3 lightDir, vec3 color)
{
    gpu.activate();
...
const char* Cube::fs = R"(
  ...
  void main() {
    ...
    outputColour = vec4( NdotL * color, 1.0 );
  }
)";
